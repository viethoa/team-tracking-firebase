...
public class DialogUtils extends DialogFragment {
    ...
    public static Dialog createDialogMessage(Context activity, String title, String message,
        ...
        View customView = inflater.inflate(R.layout.dialog_message_layout, null);
        final Dialog dialog = DialogUtils.createSimpleDialog(activity, customView, cancelable);
        ...
        Button btnNegative = (Button) customView.findViewById(R.id.btn_negative);
        Button btnPositive = (Button) customView.findViewById(R.id.btn_positive);
